...
INSERT INTO @resourceNames VALUES ('gradeLevelDescriptor'),('academicSubjectDescriptor'),('educationStandards')
...
-- Add managed descriptors to the assessment vendor claimset
